...
<body style="margin-top: 30px; background: linear-gradient(#8B008B, #FF1493);">
    <div class="container" style="background-color: #FF69B4; border-radius: 10px; width: 50%; padding: 30px; margin-bottom: 20px;">
        ...
        <div class="main">
            <form method="post" action="ubah.php" enctype="multipart/form-data">
                ...
                <input class="tombol" style=" margin-top: 10px; border-radius: 3px; border: none;" type="submit" name="submit" value="Simpan"/>
                </div>
            </form>
        </div>
    </div>

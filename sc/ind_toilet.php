...
<head>
    ...
    <style>
        body{
            background: linear-gradient( #fff, #F5F5DC, #A9A9A9);
        }
    </style>
</head>
<body style="margin-top: 30px; background-color: #0A2647;">
    <div class="container" class="container" style="background-color: grey; width: 50%; padding: 30px;">
        <br><br>
        <div class="head">
        ...
        <div class="main">
            ...
            <tr>
                ...
                <td style="color: #FFFFFF;">
                    <button class="btn" type="button" style="background-color: #e4492e; width: 70%;"><a style="color: #FFFFFF; text-decoration: none;" href="hap_toilet.php?id=<?= $row['id'];?>">Hapus Data</a></button>
                </td>
            </tr>
            <?php endwhile; else: ?>
            <tr>
        ...
        <div>
        <button class="btn" type="button" style="background-color: #07940e;"><a style="color: #FFFFFF; text-decoration: none;" href="tam_toilet.php">Tambah Data Toilet</a></button>
        </div> <br>
        <div>
        <button class="btn" type="button" style="background-color: #07940e;"><a style="color: #FFFFFF; text-decoration: none;" href="home.php">Kembali</a></button>
        </div>
    </div>
</body>
</html>
...
<body style="margin-top: 30px; background-color: #F0E68C;">
    <div class="container" style="background-color: #FFDAB9; width: 50%; padding: 30px;">
        <h1 style="color: #00000; text-align: center;">Tambah Data</h1>
        <div class="main">
            <form method="post" action="tambah.php" enctype="multipart/form-data">
                ...
                <input class= "btn" style="background-color: #fff; color: black;" type="submit" name="submit" value="Simpan">
            </form>
        </div>
    </div>
</body>

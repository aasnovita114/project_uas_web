...
<body style="margin-top: 30px; background-color: #7eeef3;">
    <div class="container" style="background-color: #F0E68C; width: 250%; padding: 10px;">
        <br><br>
        <div class="head">
        <h1 style="color: #00000;">Checklist Toilet</h1>
        <form>
            <div class="form-group" action="index.php" method="get" >
                <label for="q" style="color: #00000;">Cari Data Toilet</label>
        ...
        <div>
        <button class="btn" type="button" style="background-color: #07940e;"><a style="color: #7eeef3; text-decoration: none;"  href="tambah.php">Tambah Data Checklist</a></button>
        </div> <br>
        <div>
